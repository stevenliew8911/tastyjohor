...
public class RandomChineseFood20kmDialog extends Dialog {
    ...
    public RandomChineseFood20kmDialog(Context context) {
        super(context);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                ChineseFoodPageBelow20km.activity_20km.runOnUiThread(setImageRunnable);
            }
