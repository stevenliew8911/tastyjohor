...
public class RandomChineseFood10kmDialog extends Dialog {
    ...
    public RandomChineseFood10kmDialog(Context context) {
        super(context);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                ChineseFoodPageBelow10km.activity_10km.runOnUiThread(setImageRunnable);
            }
