package com.update.food.RandomChineseFoodDialog;
...
public class RandomChineseFood15kmDialog extends Dialog {
    ...
    public int randomChineseFoodID;



    public RandomChineseFood15kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow15km.get(randomChineseFoodID);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                ChineseFoodPageBelow15km.activity_15km.runOnUiThread(setImageRunnable);
            }
