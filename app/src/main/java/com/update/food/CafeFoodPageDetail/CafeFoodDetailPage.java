package com.update.food.CafeFoodPageDetail;
...
import com.update.food.TimeDialog.TimeDialog;
 ...
 */
public class CafeFoodDetailPage extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cafe_food_page_detail);
        ...
        address = (TextView) findViewById(R.id.address_cafe);
        description = (TextView) findViewById(R.id.description_cafe);
        ...
        rating.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(final RatingBar ratingBar, float v, boolean b) {
                AlertDialog.Builder builder = new AlertDialog.Builder(CafeFoodDetailPage.this);
                builder.setMessage(
        ...
        line2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TimeDialog cdd=new TimeDialog(CafeFoodDetailPage.this,ShopOwnerDescription,dayOfTheWeek);
        ...
        //description.setText(ShopOwnerDescription);
...
//        }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults)
    {
        if (requestCode == REQUEST_LOCATION)
        {
            ...
            {
              //  fm = ((MapFragment) getFragmentManager().findFragmentById(R.id.map)).getMap();
                // Enabling MyLocation Layer of Google Map
                fm = ((MapFragment) getFragmentManager().findFragmentById(R.id.map));
                fm.getMapAsync(this);
    ...
    private void moveToCurrentLocation(LatLng currentLocation,GoogleMap google)
    {
        google.moveCamera(CameraUpdateFactory.newLatLngZoom(currentLocation, 15));
        // Zoom in, animating the camera.
        google.animateCamera(CameraUpdateFactory.zoomIn());
        // Zoom out to zoom level 10, animating with a duration of 2 seconds.
        google.animateCamera(CameraUpdateFactory.zoomTo(15), 2000, null);
