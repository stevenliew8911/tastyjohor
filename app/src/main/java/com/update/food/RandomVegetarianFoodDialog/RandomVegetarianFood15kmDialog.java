...
public class RandomVegetarianFood15kmDialog extends Dialog {
    ...
    public RandomVegetarianFood15kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow15km.get(randomVegetarianFoodID);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                VegetarianFoodPageBelow15km.activity_15km.runOnUiThread(setImageRunnable);
            }
