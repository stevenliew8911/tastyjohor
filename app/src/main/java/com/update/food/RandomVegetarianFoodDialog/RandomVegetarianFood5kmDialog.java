...
public class RandomVegetarianFood5kmDialog extends Dialog {
    ...
    public RandomVegetarianFood5kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow5km.get(randomVegetarianFoodID);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                VegetarianFoodPageBelow5km.activity_5km.runOnUiThread(setImageRunnable);
            }
