...
public class RandomVegetarianFood20kmDialog extends Dialog {
    ...
    public RandomVegetarianFood20kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow20km.get(randomVegetarianFoodID);

                Intent intent = new Intent(context, VegetarianFoodPageBelow20km.class);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                VegetarianFoodPageBelow20km.activity_20km.runOnUiThread(setImageRunnable);
            }
