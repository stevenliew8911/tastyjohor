...
import com.update.food.JapaneseFoodPageDistance.JapaneseFoodPageBelow10km;
import com.update.food.JapaneseFoodPageDistance.JapaneseFoodPageBelow15km;
import com.update.food.JapaneseFoodPageDistance.JapaneseFoodPageBelow20km;
import com.update.food.JapaneseFoodPageDistance.JapaneseFoodPageBelow5km;
 ...
 */
public class JapaneseFoodPage extends AppCompatActivity {
    Toolbar toolbarMain;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.japanese_food_homepage);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                ShopList shoplist = GetJapaneseShopListTask.listMockData.get(position);

                Intent intent = new Intent(getApplicationContext(), JapaneseFoodDetailPage.class);
...
// arraylist to keep the selected items
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        for(int i=0; i<selected.length; i++)
                        {
                            if(selected[i]==true)
                            {
                                if(i==0)
                                {
                                    Intent intent = new Intent(getApplicationContext(), JapaneseFoodPageBelow5km.class);
                                    startActivity(intent);
                                }
                                if(i==1)
                                {
                                    Intent intent = new Intent(getApplicationContext(), JapaneseFoodPageBelow10km.class);
                                    startActivity(intent);

                                }
                                if(i==2)
                                {
                                    Intent intent = new Intent(getApplicationContext(), JapaneseFoodPageBelow15km.class);
                                    startActivity(intent);
                                }
                                if(i==3)
                                {
                                    Intent intent = new Intent(getApplicationContext(), JapaneseFoodPageBelow20km.class);
                                    startActivity(intent);
    ...
    public void clearshopdetail()
    {
        ...
        GetJapaneseShopListTask.listMockData.clear();
    ...
    public void fetchshopdata() {
        ...
        new GetJapaneseShopListTask(this, list).execute();
    ...
    public void initialize()
    {
        ...
        timer=new Timer();
        timer.schedule(new JapaneseFoodPage.GetLastLocation(), 0);
