 ...
 */
public class KoreanFoodPage extends AppCompatActivity {
    Toolbar toolbarMain;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.korean_food_homepage);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                ShopList shoplist = GetKoreanShopListTask.listMockData.get(position);

                Intent intent = new Intent(getApplicationContext(), KoreanFoodDetailPage.class);
...
// arraylist to keep the selected items
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        for(int i=0; i<selected.length; i++)
                        {
                            if(selected[i]==true)
                            {
                                if(i==0)
                                {
                                    Intent intent = new Intent(getApplicationContext(), KoreanFoodPageBelow5km.class);
                                    startActivity(intent);
                                }
                                if(i==1)
                                {
                                    Intent intent = new Intent(getApplicationContext(), KoreanFoodPageBelow10km.class);
                                    startActivity(intent);

                                }
                                if(i==2)
                                {
                                    Intent intent = new Intent(getApplicationContext(),KoreanFoodPageBelow15km.class);
                                    startActivity(intent);
                                }
                                if(i==3)
                                {
                                    Intent intent = new Intent(getApplicationContext(), KoreanFoodPageBelow20km.class);
                                    startActivity(intent);
    ...
    public void clearshopdetail()
    {
        ...
        GetKoreanShopListTask.listMockData.clear();
    ...
    public void fetchshopdata() {
        ...
        new GetKoreanShopListTask(this, list).execute();
    ...
    public void initialize()
    {
        ...
        timer=new Timer();
        timer.schedule(new KoreanFoodPage.GetLastLocation(), 0);
