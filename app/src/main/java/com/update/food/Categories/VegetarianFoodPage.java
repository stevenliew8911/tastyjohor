...
import com.update.food.LocalFoodPageDetail.LocalFoodDetailPage;
import com.update.food.LocalFoodPageDistance.LocalFoodPageBelow10km;
import com.update.food.LocalFoodPageDistance.LocalFoodPageBelow15km;
import com.update.food.LocalFoodPageDistance.LocalFoodPageBelow20km;
import com.update.food.LocalFoodPageDistance.LocalFoodPageBelow5km;
...
import com.update.food.VegetarianFoodPageDistance.VegetarianFoodPageBelow15km;
import com.update.food.VegetarianFoodPageDistance.VegetarianFoodPageBelow20km;
import com.update.food.VegetarianFoodPageDistance.VegetarianFoodPageBelow5km;
 ...
 */
public class VegetarianFoodPage extends AppCompatActivity {
    Toolbar toolbarMain;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vegetarian_food_homepage);
        overridePendingTransition(R.drawable.animation_left_in, R.drawable.animation_left_out);
        //Fetch data first


        // adapter = new SearchableAdapter(this, shopdata, currentlatitude, currentlongtitude);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                ShopList shoplist = GetVegetarianShopListTask.listMockData.get(position);

                Intent intent = new Intent(getApplicationContext(), VegetarianFoodDetailPage.class);
...
// arraylist to keep the selected items
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        for(int i=0; i<selected.length; i++)
                        {
                            if(selected[i]==true)
                            {
                                if(i==0)
                                {
                                    Intent intent = new Intent(getApplicationContext(), VegetarianFoodPageBelow5km.class);
                                    startActivity(intent);
                                }
                                if(i==1)
                                {
                                    Intent intent = new Intent(getApplicationContext(), VegetarianFoodPageBelow10km.class);
                                    startActivity(intent);

                                }
                                if(i==2)
                                {
                                    Intent intent = new Intent(getApplicationContext(),VegetarianFoodPageBelow15km.class);
                                    startActivity(intent);
                                }
                                if(i==3)
                                {
                                    Intent intent = new Intent(getApplicationContext(), VegetarianFoodPageBelow20km.class);
                                    startActivity(intent);
    ...
    public void clearshopdetail()
    {
        ...
        GetVegetarianShopListTask.listMockData.clear();
    ...
    public void fetchshopdata() {
        ...
        new GetVegetarianShopListTask(this, list).execute();
    ...
    public void initialize()
    {
        ...
        timer=new Timer();
        timer.schedule(new VegetarianFoodPage.GetLastLocation(), 0);
