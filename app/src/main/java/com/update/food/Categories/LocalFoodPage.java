...
import com.update.food.KoreanFoodPageDistance.KoreanFoodPageBelow10km;
import com.update.food.KoreanFoodPageDistance.KoreanFoodPageBelow15km;
import com.update.food.KoreanFoodPageDistance.KoreanFoodPageBelow20km;
import com.update.food.KoreanFoodPageDistance.KoreanFoodPageBelow5km;
 ...
 */
public class LocalFoodPage extends AppCompatActivity {
    Toolbar toolbarMain;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.local_food_homepage);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                ShopList shoplist = GetLocalShopListTask.listMockData.get(position);

                Intent intent = new Intent(getApplicationContext(), LocalFoodDetailPage.class);
...
// arraylist to keep the selected items
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        for(int i=0; i<selected.length; i++)
                        {
                            if(selected[i]==true)
                            {
                                if(i==0)
                                {
                                    Intent intent = new Intent(getApplicationContext(), LocalFoodPageBelow5km.class);
                                    startActivity(intent);
                                }
                                if(i==1)
                                {
                                    Intent intent = new Intent(getApplicationContext(), LocalFoodPageBelow10km.class);
                                    startActivity(intent);

                                }
                                if(i==2)
                                {
                                    Intent intent = new Intent(getApplicationContext(),LocalFoodPageBelow15km.class);
                                    startActivity(intent);
                                }
                                if(i==3)
                                {
                                    Intent intent = new Intent(getApplicationContext(), LocalFoodPageBelow20km.class);
                                    startActivity(intent);
    ...
    public void clearshopdetail()
    {
        ...
        GetLocalShopListTask.listMockData.clear();
    ...
    public void fetchshopdata() {
        ...
        new GetLocalShopListTask(this, list).execute();
    ...
    public void initialize()
    {
        ...
        timer=new Timer();
        timer.schedule(new LocalFoodPage.GetLastLocation(), 0);
