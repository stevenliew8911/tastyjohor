package com.update.food.KoreanFoodPageDetail;
 ...
 */
public class KoreanFoodDetailPage extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.korean_food_page_detail);
        ...
        address = (TextView) findViewById(R.id.address_korean);
        description = (TextView) findViewById(R.id.description_korean);
        ...
        rating.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(final RatingBar ratingBar, float v, boolean b) {
                AlertDialog.Builder builder = new AlertDialog.Builder(KoreanFoodDetailPage.this);
                builder.setMessage(
        ...
        line2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TimeDialog cdd=new TimeDialog(KoreanFoodDetailPage.this,ShopOwnerDescription,dayOfTheWeek);
