...
public class RandomLocalFood10kmDialog extends Dialog {
    ...
    public RandomLocalFood10kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow10km.get(randomLocalFoodID);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                LocalFoodPageBelow10km.activity_10km.runOnUiThread(setImageRunnable);
            }
