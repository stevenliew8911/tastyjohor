...
public class RandomLocalFood15kmDialog extends Dialog {
    ...
    public RandomLocalFood15kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow15km.get(randomLocalFoodID);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                LocalFoodPageBelow15km.activity_15km.runOnUiThread(setImageRunnable);
            }
    ...
    public void randomShopID()
    {
        ...
        String random = SearchableAdapter.ShopListbelow15km.get(rand.nextInt(SearchableAdapter.ShopListbelow15km.size())).getShopID();
        for(int i=0; i<SearchableAdapter.ShopListbelow15km.size(); i++)
        {
            if(SearchableAdapter.ShopListbelow15km.get(i).getShopID()==random)
            {
                randomLocalFoodID=i;
                ShopList shoplist = SearchableAdapter.ShopListbelow15km.get(i);
                ...
                text3.setText(" Distance: " + SearchableAdapter.Locationdistancebelow15km.get(i)+" km" +"\n "+
                        "Duration: "+SearchableAdapter.Locationtimebelow15km.get(i)+ " mins");
