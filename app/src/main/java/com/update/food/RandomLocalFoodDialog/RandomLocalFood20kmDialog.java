package com.update.food.RandomLocalFoodDialog;
...
public class RandomLocalFood20kmDialog extends Dialog {
    ...
    public int randomLocalFoodID;



    public RandomLocalFood20kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow20km.get(randomLocalFoodID);

                Intent intent = new Intent(context, LocalFoodDetailPage.class);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                LocalFoodPageBelow20km.activity_20km.runOnUiThread(setImageRunnable);
            }
    ...
    public void randomShopID()
    {
        ...
        String random = SearchableAdapter.ShopListbelow20km.get(rand.nextInt(SearchableAdapter.ShopListbelow20km.size())).getShopID();
        for(int i=0; i<SearchableAdapter.ShopListbelow20km.size(); i++)
        {
            if(SearchableAdapter.ShopListbelow20km.get(i).getShopID()==random)
            {
                randomLocalFoodID=i;
                ShopList shoplist = SearchableAdapter.ShopListbelow20km.get(i);
                ...
                text3.setText(" Distance: " + SearchableAdapter.Locationdistancebelow20km.get(i)+" km" +"\n "+
                        "Duration: "+SearchableAdapter.Locationtimebelow20km.get(i)+ " mins");
