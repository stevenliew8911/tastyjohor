...
public class RandomLocalFood5kmDialog extends Dialog {
    ...
    public RandomLocalFood5kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow5km.get(randomLocalFoodID);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                LocalFoodPageBelow5km.activity_5km.runOnUiThread(setImageRunnable);
            }
    ...
    public void randomShopID()
    {
        ...
        String random = SearchableAdapter.ShopListbelow5km.get(rand.nextInt(SearchableAdapter.ShopListbelow5km.size())).getShopID();
        for(int i=0; i<SearchableAdapter.ShopListbelow5km.size(); i++)
        {
            if(SearchableAdapter.ShopListbelow5km.get(i).getShopID()==random)
            {
                randomLocalFoodID=i;
                ShopList shoplist = SearchableAdapter.ShopListbelow5km.get(i);
                ...
                text3.setText(" Distance: " + SearchableAdapter.Locationdistancebelow5km.get(i)+" km" +"\n "+
                        "Duration: "+SearchableAdapter.Locationtimebelow5km.get(i)+ " mins");
