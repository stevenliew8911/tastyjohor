package com.update.food.RandomCafeFoodDialog;
...
public class RandomCafeFood5kmDialog extends Dialog {
    ...
    public int randomCafeFoodID;



    public RandomCafeFood5kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow5km.get(randomCafeFoodID);

                Intent intent = new Intent(context, CafeFoodDetailPage.class);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                CafeFoodPageBelow5km.activity_5km.runOnUiThread(setImageRunnable);
            }
    ...
    public void randomShopID()
    {
        ...
        for(int i=0; i<SearchableAdapter.ShopListbelow5km.size(); i++)
        {
            if(SearchableAdapter.ShopListbelow5km.get(i).getShopID()==random)
            {
                ...
                int temp=Integer.parseInt(shoplist.getShopRatingHits());
                int temp2 =Integer.parseInt(shoplist.getShopRatingMarks());
                if(temp== 0)
                {
