...
public class RandomCafeFood20kmDialog extends Dialog {
    ...
    public RandomCafeFood20kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow20km.get(randomCafeFoodID);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                CafeFoodPageBelow20km.activity_20km.runOnUiThread(setImageRunnable);
            }
