...
public class RandomCafeFood10kmDialog extends Dialog {
    ...
    public RandomCafeFood10kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow10km.get(randomCafeFoodID);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                CafeFoodPageBelow10km.activity_10km.runOnUiThread(setImageRunnable);
            }
