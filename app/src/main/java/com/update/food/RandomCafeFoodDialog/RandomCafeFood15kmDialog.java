...
public class RandomCafeFood15kmDialog extends Dialog {
    ...
    public RandomCafeFood15kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow15km.get(randomCafeFoodID);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                CafeFoodPageBelow15km.activity_15km.runOnUiThread(setImageRunnable);
            }
