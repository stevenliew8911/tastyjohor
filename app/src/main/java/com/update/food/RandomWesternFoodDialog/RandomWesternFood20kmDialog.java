package com.update.food.RandomWesternFoodDialog;
...
public class RandomWesternFood20kmDialog extends Dialog {
    ...
    public RandomWesternFood20kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow20km.get(randomChineseFoodID);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                WesternFoodPageBelow20km.activity_20km.runOnUiThread(setImageRunnable);
            }
