...
public class RandomWesternFood5kmDialog extends Dialog {
    ...
    public int randomWesternFoodID;



    public RandomWesternFood5kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow5km.get(randomWesternFoodID);

                Intent intent = new Intent(context, WesternFoodDetailPage.class);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                WesternFoodPageBelow5km.activity_5km.runOnUiThread(setImageRunnable);
            }
