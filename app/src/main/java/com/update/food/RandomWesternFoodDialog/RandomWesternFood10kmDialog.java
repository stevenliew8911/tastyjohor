...
public class RandomWesternFood10kmDialog extends Dialog {
    ...
    public RandomWesternFood10kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow10km.get(randomChineseFoodID);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                WesternFoodPageBelow10km.activity_10km.runOnUiThread(setImageRunnable);
            }
