...
public class RandomWesternFood15kmDialog extends Dialog {
    ...
    public RandomWesternFood15kmDialog(Context context) {
        super(context);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                WesternFoodPageBelow15km.activity_15km.runOnUiThread(setImageRunnable);
            }
