...
import com.update.food.CalculateDistanceFunction.CalculateDistanceTaskChinese;
import com.update.food.CalculateDistanceFunction.CalculateDistanceTaskJapanese;
 ...
 */
public class GetJapaneseShopListTask extends AsyncTask<Void, Integer, ArrayList<ShopList>> {
    ...
    public GetJapaneseShopListTask(Context context, ListView list)
    {
    ...
    protected void onPostExecute(final ArrayList<ShopList> result)
    {
        ...
        JapaneseFoodPage.shopdata=result;
        try
        {

            new CalculateDistanceTaskJapanese(context,GetJapaneseShopListTask.listMockData).execute(JapaneseFoodPage.currentlatitude, JapaneseFoodPage.currentlongtitude);
