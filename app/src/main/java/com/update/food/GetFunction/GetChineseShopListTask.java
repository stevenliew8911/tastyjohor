 ...
 */
public class GetChineseShopListTask extends AsyncTask<Void, Integer, ArrayList<ShopList>> {
    ...
    public GetChineseShopListTask(Context context, ListView list)
    {
    ...
    protected void onPostExecute(final ArrayList<ShopList> result)
    {
       ...
       ChineseFoodPage.shopdata=result;

        try
        {

            new CalculateDistanceTaskChinese(context,GetChineseShopListTask.listMockData).execute(ChineseFoodPage.currentlatitude, ChineseFoodPage.currentlongtitude);
