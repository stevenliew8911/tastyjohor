...
import com.update.food.CalculateDistanceFunction.CalculateDistanceTaskKorean;
 ...
 */
public class GetKoreanShopListTask extends AsyncTask<Void, Integer, ArrayList<ShopList>> {
    ...
    public GetKoreanShopListTask(Context context, ListView list)
    {
    ...
    protected void onPostExecute(final ArrayList<ShopList> result)
    {
        ...
        KoreanFoodPage.shopdata=result;
        try
        {

            new CalculateDistanceTaskKorean(context,GetKoreanShopListTask.listMockData).execute(KoreanFoodPage.currentlatitude, KoreanFoodPage.currentlongtitude);
