 ...
 */
public class GetWesternShopListTask extends AsyncTask<Void, Integer, ArrayList<ShopList>> {
    ...
    public GetWesternShopListTask(Context context, ListView list)
    {
    ...
    protected void onPostExecute(final ArrayList<ShopList> result)
    {
        ...
        WesternFoodPage.shopdata=result;
        try
        {

            new CalculateDistanceTaskWestern(context,GetWesternShopListTask.listMockData).execute(WesternFoodPage.currentlatitude, WesternFoodPage.currentlongtitude);
