...
import com.update.food.CalculateDistanceFunction.CalculateDistanceTaskVegetarian;
 ...
 */
public class GetVegetarianShopListTask extends AsyncTask<Void, Integer, ArrayList<ShopList>> {
    ...
    public GetVegetarianShopListTask(Context context, ListView list) {
    ...
    protected void onPostExecute(final ArrayList<ShopList> result) {
        ...
        VegetarianFoodPage.shopdata = result;
        try {

            new CalculateDistanceTaskVegetarian(context, GetVegetarianShopListTask.listMockData).execute(VegetarianFoodPage.currentlatitude, VegetarianFoodPage.currentlongtitude);
