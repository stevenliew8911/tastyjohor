package com.update.food.JapaneseFoodPageDetail;
 ...
 */
public class JapaneseFoodDetailPage extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.japanese_food_page_detail);
       ...
       // address.setText("");
        ...
        address = (TextView) findViewById(R.id.address_japanese);
        description = (TextView) findViewById(R.id.description_japanese);
        ...
        rating.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(final RatingBar ratingBar, float v, boolean b) {
                AlertDialog.Builder builder = new AlertDialog.Builder(JapaneseFoodDetailPage.this);
                builder.setMessage(
        ...
        line2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TimeDialog cdd=new TimeDialog(JapaneseFoodDetailPage.this,ShopOwnerDescription,dayOfTheWeek);
