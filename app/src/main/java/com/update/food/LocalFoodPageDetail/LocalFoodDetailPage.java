package com.update.food.LocalFoodPageDetail;
 ...
 */
public class LocalFoodDetailPage extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.local_food_page_detail);
        ...
        address = (TextView) findViewById(R.id.address_local);
        description = (TextView) findViewById(R.id.description_local);
        ...
        rating.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(final RatingBar ratingBar, float v, boolean b) {
                AlertDialog.Builder builder = new AlertDialog.Builder(LocalFoodDetailPage.this);
                builder.setMessage(
