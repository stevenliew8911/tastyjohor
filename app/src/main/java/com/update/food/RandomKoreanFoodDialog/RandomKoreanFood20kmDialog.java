...
public class RandomKoreanFood20kmDialog extends Dialog {
    ...
    public RandomKoreanFood20kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow20km.get(randomKoreanFoodID);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                KoreanFoodPageBelow20km.activity_20km.runOnUiThread(setImageRunnable);
            }
