package com.update.food.RandomKoreanFoodDialog;
...
public class RandomKoreanFood15kmDialog extends Dialog {
    ...
    public int randomKoreanFoodID;



    public RandomKoreanFood15kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow15km.get(randomKoreanFoodID);

                Intent intent = new Intent(context, KoreanFoodDetailPage.class);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                KoreanFoodPageBelow15km.activity_15km.runOnUiThread(setImageRunnable);
            }
