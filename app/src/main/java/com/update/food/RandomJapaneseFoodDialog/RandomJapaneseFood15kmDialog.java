...
public class RandomJapaneseFood15kmDialog extends Dialog {
    ...
    public RandomJapaneseFood15kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow15km.get(randomJapaneseFoodID);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                JapaneseFoodPageBelow15km.activity_15km.runOnUiThread(setImageRunnable);
            }
