package com.update.food.RandomJapaneseFoodDialog;
...
public class RandomJapaneseFood20kmDialog extends Dialog {
    ...
    public int randomJapaneseFoodID;



    public RandomJapaneseFood20kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow20km.get(randomJapaneseFoodID);

                Intent intent = new Intent(context, JapaneseFoodDetailPage.class);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                JapaneseFoodPageBelow20km.activity_20km.runOnUiThread(setImageRunnable);
            }
