...
public class RandomJapaneseFood5kmDialog extends Dialog {
    ...
    public RandomJapaneseFood5kmDialog(Context context) {
        super(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        relative1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ShopList shoplist = SearchableAdapter.ShopListbelow5km.get(randomJapaneseFoodID);
    ...
    private void setTimerTask() {
        mTimer.schedule(new TimerTask() {
            ...
            @Override
            public void run() {
                JapaneseFoodPageBelow5km.activity_5km.runOnUiThread(setImageRunnable);
            }
