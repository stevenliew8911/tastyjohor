package com.update.food.ChineseFoodPageDetail;
 ...
 */
public class ChineseFoodDetailPage extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chinese_food_page_detail);
        ...
        address = (TextView) findViewById(R.id.address_chinese);
        description = (TextView) findViewById(R.id.description_chinese);
        ...
        rating.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(final RatingBar ratingBar, float v, boolean b) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ChineseFoodDetailPage.this);
                builder.setMessage(
...
//        }
    ...
    public void UpdateRatingHits(float marks)
    {
        ...
        la.execute(ShopID,String.valueOf(temp),String.valueOf(totalmarks),"chineseshop");
