package com.update.food.VegetarianFoodPageDetail;
 ...
 */
public class VegetarianFoodDetailPage extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vegetarian_food_page_detail);
        ...
        address = (TextView) findViewById(R.id.address_vegetarian);
        description = (TextView) findViewById(R.id.description_vegetarian);
        ...
        rating.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(final RatingBar ratingBar, float v, boolean b) {
                AlertDialog.Builder builder = new AlertDialog.Builder(VegetarianFoodDetailPage.this);
                builder.setMessage(
